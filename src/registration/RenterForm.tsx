...
const RepeatSelfieVerification: React.FC<RepeatSelfieVerificationProps> = ({ selfiePreview, onSelfieCapture, error }) => (
  <Paper elevation={0} sx={{ p: { xs: 2, sm: 2.5 }, background: '#ffffff', border: '1px solid #f1e5d0', borderRadius: '24px', boxShadow: '0 8px 24px rgba(0,0,0,0.04)', color: '#111111' }}>
    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1.5 }}>
      <Box sx={{ width: 42, height: 42, borderRadius: '14px', background: '#fff7e8', border: '1px solid #f1e5d0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <Box>
        ...
        <Typography variant="body2" sx={{ color: '#6b7280' }}>Capture a new clear selfie before submitting this rental.</Typography>
      </Box>
    </Box>
    <Alert severity="info" sx={{ mb: 2, borderRadius: '14px' }}>{SELFIE_REMINDER}</Alert>
    <CameraCapture label="Live Selfie Capture" facingMode="user" onCapture={onSelfieCapture} capturedUrl={selfiePreview} hint="Use the device camera only. Gallery uploads and manual file selection are not accepted for repeat-renter verification." variant="lightVerification" />
